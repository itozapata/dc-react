...
var ChartPropertyHelper = function () {
  ...
  _createClass(ChartPropertyHelper, [{
    ...
    value: function setObjectProperty(key) {
      if (this.props.hasOwnProperty(key)) {
        var _chart2;

        var val = this.props[key];
        var vals = Object.keys(val).map(function (key) {
          return val[key];
        });
        (_chart2 = this.chart)[key].apply(_chart2, _toConsumableArray(vals));
      }
      return this;
    }
  }, {
