  ...
  return _temp2 = _class = function (_Component) {
    ...
    function _class() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _class.__proto__ || Object.getPrototypeOf(_class)).call.apply(_ref, [this].concat(args))), _this), _this.dcHelper = function (dcComponent, dcChart) {
        ...
        if (loadDefault) {
          helper.setProperties('width', 'height', 'title', 'label', 'transitionDuration', 'margins', 'mouseZoomable', 'legend', 'renderLabel', 'renderTitle', 'filterHandler', 'onClick').setContextProperties('dimension', 'group');
        }
    ...
    renderLabel: _react.PropTypes.bool,
    renderTitle: _react.PropTypes.bool,
    chartGroup: _react.PropTypes.string,
    filterHandler: _react.PropTypes.func,
