...
var LineChart = function (_Component) {
  ...
  function LineChart() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = LineChart.__proto__ || Object.getPrototypeOf(LineChart)).call.apply(_ref, [this].concat(args))), _this), _this.loadChart = function (container) {
      ...
      helper.setProperties('renderArea', 'xAxis', 'x', 'round', 'xUnits', 'elasticY', 'renderHorizontalGridLines', 'brushOn', 'valueAccessor', 'renderVerticalGridLines', 'colors', 'onPretransition', 'onRenderlet', 'onFiltered', 'defined').setContextProperties('stack');
